...
| Traceability | MISSING | PRESENT-CURRENT | Added requirement/decision -> source/schema/test/evidence mapping, including scheduler failure recovery authority and the material-safe-action handoff. |
