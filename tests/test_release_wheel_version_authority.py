...
"""Regression contract for unsupported wheel-format major versions."""
...
def _wheel_with_unsupported_major() -> bytes:
    """Return a canonical wheel payload declaring unsupported Wheel-Version 2.0."""
...
def test_release_verifier_rejects_unsupported_wheel_major_version(tmp_path: Path) -> None:
    """Reject release evidence for a wheel format with an unsupported major version."""
    sdist_bytes = _matching_sdist()
    wheel_bytes = _wheel_with_unsupported_major()
