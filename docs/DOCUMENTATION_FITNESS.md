...
| Traceability | MISSING | PRESENT-CURRENT | Added requirement/decision -> source/schema/test/evidence mapping, including scheduler recovery, #116/#117 argv privacy gaps, #118 PostgreSQL image reproducibility, #119/#120 logging boundaries, #121 secret-encryption policy, and #122 package-owned PostgreSQL wait-budget planning. |
