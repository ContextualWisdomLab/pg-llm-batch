...
| Candidate supply-chain admission | Active / strengthened | Exact wheel hashes and license metadata are gated; complete vulnerability/SBOM/provenance and final runtime-graph evidence before promotion. |
