...
| Threat model | MISSING | PRESENT-CURRENT | Added as `docs/THREAT_MODEL.md`; separates package and host responsibilities, classifies #105 caller-owned error-evidence alias drift, #106 description-free operation-span Error status, #119 persistent-vs-volatile PostgreSQL query-text exposure, #126 runtime/provision authority, and #127 durable lifecycle provider-field risk without overclaiming shipped controls. |
