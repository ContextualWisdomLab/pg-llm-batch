...
- #101 — fail-closed retirement of the legacy direct-SQL `pg_cron` + `pgsql-http` provider retriever while preserving historical retrieval logs and keeping provider network/credential authority in the Python client layer.
