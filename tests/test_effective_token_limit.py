...
@pytest.mark.parametrize(
    "value",
    [0, -1, True, False, 1.5, "100", object()],
)
def test_invalid_token_limits_raise_redacted_structured_validation_errors(value):
    """Rejected runtime limits do not gain implicit diagnostic disclosure authority."""
...
def test_oversized_numeric_evidence_stays_redacted():
    """Oversized numeric diagnostics remain bounded by the default redaction policy."""
...
def test_integer_render_limit_is_irrelevant_to_rejected_value_redaction():
