...
| Traceability | MISSING | PRESENT-CURRENT | Added requirement/decision -> source/schema/test/evidence mapping, including scheduler failure recovery, the compact prompt source, public runtime hardening, #116/#117 argv privacy gaps, #118 PostgreSQL image reproducibility, #119 PostgreSQL logging privacy, #120 logging operability, and the planned #121 secret-encryption policy decision. |
