...
| Threat model | MISSING | PRESENT-CURRENT | Added as `docs/THREAT_MODEL.md`; separates package and host responsibilities and classifies #105 caller-owned error-evidence alias drift without immutable-audit overclaims. |
...
| Traceability | MISSING | PRESENT-CURRENT | Added requirement/decision -> source/schema/test/evidence mapping, including scheduler failure recovery, the compact prompt source, public runtime hardening, and structured error evidence authority. |
