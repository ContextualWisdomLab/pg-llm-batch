...
11. 33 simultaneously offered requests allocate at most 32 workers and close the excess request before database work; and
12. both successful request completion and thread-start failure return the admission slot so capacity cannot leak across requests.
