...
| Technical requirements | MISSING | PRESENT-CURRENT | Added as `docs/product/TRD.md`; #106 operation-span failure-status and #119 PostgreSQL logging privacy semantics are explicitly ACTIVE-PR rather than shipped. |
...
| Traceability | MISSING | PRESENT-CURRENT | Added requirement/decision -> source/schema/test/evidence mapping, including scheduler failure recovery, the compact prompt source, public runtime hardening, #116/#117 argv privacy gaps, and #119 PostgreSQL logging privacy. |
