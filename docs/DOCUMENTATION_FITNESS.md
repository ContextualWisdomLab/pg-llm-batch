...
| Maintenance-governance ADRs | MISSING | PRESENT-CURRENT | Work conservation, evidence identity, writer lease, canonical-documentation authority, semantic review vs infrastructure/policy evidence separation, and protected-main operational acceptance are now durable; see `docs/automation/ADR-0004-review-evidence-separation.md` and `docs/automation/ADR-0005-protected-main-operational-acceptance.md`. |
...
- #93 — this canonical documentation authority, data-governance/privacy authority, licensing/IP diligence authority, foundational protected-main ADR record set, and protected-main operational-acceptance governance.
