...
| Public commercial-license surface | Child lane #321 / exact child GREEN observed | Preserve its two-file semantic delta across future parent movement with ordinary non-force reconciliation; do not present it as shipped until #323 integrates and protected release evidence exists. |
